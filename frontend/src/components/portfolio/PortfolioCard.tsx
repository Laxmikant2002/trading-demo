      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="space-y-2">
          ...
          >
            {formatPercent(
              (stats.unrealizedPnL /
                (stats.totalBalance - stats.unrealizedPnL)) *
                100,
            )}
          </p>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div
            className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getMarginLevelBg(stats.marginLevel)} ${getMarginLevelColor(stats.marginLevel)}`}
          >
          ...
          <div className="flex">
            ...
            <div className="text-sm">
              ...
              <div className="text-red-700">
                Your margin level is below 100%. Consider reducing positions or
                adding funds.
              </div>
            </div>
          </div>
